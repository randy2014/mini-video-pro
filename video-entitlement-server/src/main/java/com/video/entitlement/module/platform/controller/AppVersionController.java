...
public class AppVersionController {
    ...
    // ==================== 管理端接口（路径 /admin/api/v1/...，需 ADMIN 角色） ====================
    ...
    @PostMapping(value = "/admin/api/v1/versions/upload", consumes = "multipart/form-data")
    ...
    @PostMapping(value = "/admin/api/v1/versions/{id}/upload", consumes = "multipart/form-data")
    ...
    @PutMapping("/admin/api/v1/versions/{id}/status")
